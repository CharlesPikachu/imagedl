...
class GelbooruImageClient(BaseImageClient):
    ...
    def __init__(self, **kwargs):
        ...
        self.default_search_headers = {
            ...
            "accept-language": "zh-CN,zh;q=0.9,en-US;q=0.8,en;q=0.7", "cache-control": "max-age=0", "cookie": "PHPSESSID=ngt7lipci8vs7k5ualdrufj3id", "priority": "u=0, i", "sec-ch-ua-platform": "\"Windows\"",
            "referer": "https://gelbooru.com/index.php", "sec-ch-ua": "\"Google Chrome\";v=\"143\", \"Chromium\";v=\"143\", \"Not A(Brand\";v=\"24\"", "sec-ch-ua-mobile": "?0", "sec-fetch-dest": "document",
            "sec-fetch-mode": "navigate", "upgrade-insecure-requests": "1", "user-agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36",
    ...
    def _parsesearchresult(self, search_result: str):
        ...
        for item in soup.select("div.thumbnail-container article.thumbnail-preview"):
            ...
            image_info = {'candidate_urls': candidate_urls, 'raw_data': str(item), 'identifier': a.get('id') or candidate_urls[0]}
