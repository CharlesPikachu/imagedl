...
class FreeNatureStockImageClient(BaseImageClient):
    ...
    def __init__(self, **kwargs: Unpack[BaseImageClientKwargs]):
        ...
        self.default_search_headers = {"User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/144.0.0.0 Safari/537.36", "Referer": "https://freenaturestock.com/"}
        self.default_download_headers = {"User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/144.0.0.0 Safari/537.36", "Referer": "https://freenaturestock.com/"}
    ...
    def _parsesearchresult(self, search_result: str) -> list[ImageInfo]:
        ...
        urls = [urljoin(base_url, img["src"]) for img in soup.select("#grid img[src]")]
        # parse search result
